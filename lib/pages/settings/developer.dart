  ...
  Widget build(BuildContext context) {
    ...
    return SmoothCustomScrollView(
      slivers: [
        ...
        _SettingPartTitle(title: "内存".tl, icon: Icons.memory),
        _infoCard([
          _row("已用物理内存",
        ...
        _SettingPartTitle(title: "图片缓存 (Flutter ImageCache)".tl, icon: Icons.image),
        _infoCard([
        ...
        _SettingPartTitle(title: "磁盘图片缓存".tl, icon: Icons.storage),
        _infoCard([
          _row("CacheManager 占用",
              bytesToReadableString(CacheManager().currentSize)),
          _row("路径", CacheManager.cachePath),
        ]),
        _SettingPartTitle(title: "网络请求日志".tl, icon: Icons.http),
        SliverToBoxAdapter(
          child: Padding(
