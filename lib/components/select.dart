      ...
      child: InkWell(
        ...
        child: Row(
          ...
          children: [
            ...
            Icon(adaptiveIcon(LucideIcons.arrow_down, CupertinoIcons.chevron_down), color: context.colorScheme.primary),
          ],
    ...
    return SizedBox(
      ...
      child: Align(
        ...
        child: FractionallySizedBox(
          ...
          child: ClipRRect(
            child: Icon(
              adaptiveIcon(LucideIcons.check, CupertinoIcons.checkmark),
              size: iconSize,
